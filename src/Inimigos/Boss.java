...
public class Boss extends Personagens {
	...
	public Boss() {
		...
		setSprite(Constantes.getInstance().loadImage(
				"Omo/imagens/Inimigos/Omo Boss Sprite Sheet.png"));
		spriteInvencivel = Constantes.getInstance().loadImage(
				"Omo/imagens/Inimigos/Omo Boss Invincible Sprite Sheet.png");
		spriteMorto = Constantes.getInstance().loadImage(
				"Omo/imagens/Inimigos/Omo Boss Vanish Sprite Sheet.png");
		// random = new Random();
